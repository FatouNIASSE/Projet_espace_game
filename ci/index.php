...
$mysqli = new mysqli('localhost','e22013117sql','vCoK?zWS','e22013117_db2');
...
{
// La requête a echoué ...
echo 'la requete est echoue';
}
else
{
// La requête a réussi...
echo 'la requete est reussie';
}
    ...
    <section id="features" class="features" data-aos="fade-up">
      <div class="container">
        ...
        <div class="row content">
          ...
          <?php
  // Requête SELECT pour récupérer le nom du fichier
$requete = "SELECT SCE_image FROM T_SCENARIO_SCE WHERE SCE_id = 1;";
$resultat = $mysqli->query($requete);
